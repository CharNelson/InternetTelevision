...
<iframe
  ...
  src="https://www.youtube.com/embed/seFHSuL0nsw?si=_wCMUZ7atkzPgE-_"
...
unfortunately i couldnt find a way to get github to do both the hosting of the server (communicating with OBS)
and the hosting of the output stream website (communicating with the server & client);
